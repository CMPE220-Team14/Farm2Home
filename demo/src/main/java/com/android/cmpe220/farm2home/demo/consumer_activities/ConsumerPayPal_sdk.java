...
public class ConsumerPayPal_sdk extends ActionBarActivity {
   ...
   /* private static PayPalConfiguration paypalConfig = new PayPalConfiguration()
    ...
    .clientId( ConsumerUtil.paypal_sdk_id)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.consumer_activity_pay_pal_sdk);
    ...
    private void launchPayPalPayment() {
        ...
        Intent intent = new Intent(ConsumerPayPal_sdk.this, PaymentActivity.class);

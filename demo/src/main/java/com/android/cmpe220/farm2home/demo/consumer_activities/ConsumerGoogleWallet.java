...
public class ConsumerGoogleWallet extends ActionBarActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.consumer_google_wallet);
    }

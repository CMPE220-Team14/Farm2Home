 ...
 */
public class ConsumerUserProfile extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.consumer_activity_list_user);
        listView = (ListView) findViewById(R.id.listView);
        //listView.setOnItemClickListener(this);
        listView.addHeaderView(getLayoutInflater().inflate(R.layout.consumer_user_list_header, listView, false));
        getJSON();
    }
    ...
    private void showProducts(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                getApplicationContext(), list, R.layout.consumer_activity_retrieve_user,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ConsumerUserProfile.this,"Fetching Data","Wait...",false,false);
            }
    ...
    class ListitemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(ConsumerUserProfile.this);
    ...
    public void signout()
    {
        ...
        SharedPreferences sharedPreferences = ConsumerUserProfile.this.getSharedPreferences(ConsumerConfig.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        //Adding values to editor
        editor.putBoolean(ConsumerConfig.LOGGEDIN_SHARED_PREF, false);

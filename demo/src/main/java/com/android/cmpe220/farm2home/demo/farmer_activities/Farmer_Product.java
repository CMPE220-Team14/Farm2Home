...
public class Farmer_Product extends ListActivity {
    ...
    FarmerJSONParser jParser = new FarmerJSONParser();
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Farmer_Product.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Farmer_Product.this, productsList,
